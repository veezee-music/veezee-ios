...
public class LGButton: UIControl {
    ...
    @IBInspectable public var cornersRadius: CGFloat = 0.0 {
        didSet{
            setupView()
        }
    }
    ...
    @IBInspectable public var bordersColor: UIColor = UIColor.white {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var bordersWidth: CGFloat = 0.0 {
        didSet{
            setupView()
        }
    }
    ...
    fileprivate func setupBorderAndCorners() {
        if fullyRoundedCorners {
            ...
            bgContentView.layer.cornerRadius = cornersRadius
            layer.cornerRadius = cornersRadius
        }
        bgContentView.layer.borderColor = bordersColor.cgColor
        bgContentView.layer.borderWidth = bordersWidth
    }
