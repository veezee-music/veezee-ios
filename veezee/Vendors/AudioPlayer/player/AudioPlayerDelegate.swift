...
public protocol AudioPlayerDelegate: AnyObject {
    ...
    func audioPlayer(_ audioPlayer: AudioPlayer, shouldStartPlaying item: PlayableItem) -> Bool
    ...
    func audioPlayer(_ audioPlayer: AudioPlayer, willStartPlaying item: PlayableItem)
    ...
    ///   - item: Current item.
    func audioPlayer(_ audioPlayer: AudioPlayer, didFindDuration duration: TimeInterval, for item: PlayableItem)
    ...
    ///   - item: Current item.
    ///   - data: Found metadata.
    func audioPlayer(_ audioPlayer: AudioPlayer, didUpdateEmptyMetadataOn item: PlayableItem, withData data: Metadata)
    ...
    ///   - item: Current item.
    func audioPlayer(_ audioPlayer: AudioPlayer, didLoad range: TimeRange, for item: PlayableItem)
}
