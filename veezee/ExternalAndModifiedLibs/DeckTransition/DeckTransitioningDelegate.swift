...
public final class DeckTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
	...
	private let isTapOutsideDeckToDismissEnabled: Bool
	private let isSwipeToDismissEnabled: Bool
	private let alphaForPresentingView: CGFloat
	...
	@objc public init(isSwipeToDismissEnabled: Bool = true,
					  isTapOutsideDeckToDismissEnabled: Bool = true,
					  alphaForPresentingView: CGFloat = 0.8,
	...
	public func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
		let presentationController = DeckPresentationController(
			...
			isTapOutsideDeckToDismissEnabled: isTapOutsideDeckToDismissEnabled,
			alphaForPresentingView: alphaForPresentingView,
